...
Use only `scenario.json` as product evidence. Write one proposed English replacement using these exact candidate fields: `subject`, `heading`, `body`, `primary_link`, `secondary_link`.
