...
Use only `scenario.json` as product evidence. Write one proposed English replacement using these exact candidate fields: `field_label`, `helper_text`, `error_message`.
