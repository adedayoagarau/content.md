...
Use only `scenario.json` as product evidence. Write one proposed English replacement using these exact candidate fields: `heading`, `body`, `primary_button`, `secondary_button`.
