...
| `pnpm-workspace.yaml`, `pnpm-lock.yaml`, and root `tsconfig.json` | Governed T5 -> Public T3 -> Portable T1 -> Cloudflare T1 | Reconcile against the immediately prior committed state; never regenerate from an older plan branch |
